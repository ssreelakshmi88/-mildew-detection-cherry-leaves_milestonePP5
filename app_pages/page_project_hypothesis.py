...
def project_hypothesis_page_body():
    ...
    st.info(
        f"* Cherry Leaves infected with powdery mildew have white, powdery spots or "
        ...
        f" leaf.\n"
        f"* The ML model will be able to distinguish between a healthy cherry leaf "
        f" and an infected cherry leaf with at least 97% accuracy.\n"
    )

    st.success(
        f"* We believe that Cherry leaves infected with powdery mildew have a white colour/ lighter "
        ...
        f"* Average Image, Variability Image and Difference confirmed the hypothesis "
        ...
        f"* ML pipeline performance was evaluated and it differentiates a healthy leaf and an infected leaf "
